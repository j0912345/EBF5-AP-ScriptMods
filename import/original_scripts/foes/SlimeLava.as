package foes
{
   public class SlimeLava extends Foe
   {
      public static var iconInfo:Array = [2,6];
      
      public function SlimeLava(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
         graphicType = "Slime";
      ...
      {
         Skills.basicFoeAttack(13,Element.FIRE,50,Status.DRY,1,isHard ? 100 : 50);
      }
      ...
      {
         Skills.basicFoeAttack(20,Element.FIRE,100,Status.BURN,2,33);
      }
