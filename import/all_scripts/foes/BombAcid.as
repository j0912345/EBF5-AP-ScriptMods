package foes
{
   public class BombAcid extends Foe
   {
      public function BombAcid(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
         graphicType = "Nuke";
         ...
         SP = 4;
         gold = 44;
         dropList = [[Items.steel,100],[Items.pipe,30],[Items.powder,30],[Items.glass,50],[Items.virus,50]];
      ...
      public function special4() : *
      {
         ...
         Skills.basicFoeMagic(250,Element.BIO,100,isHard ? Status.SCORCHED : Status.BURN,5,100,300);
      }
   }
}
