package foes
{
   public class SlimeMud extends Foe
   {
      public static var iconInfo:Array = [2,13];
      
      public function SlimeMud(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
         graphicType = "Slime";
         ...
         SP = 1;
         gold = 5;
         dropList = [[Items.turd,30],[Items.herb,20],[Items.root,10],[Items.flower,10]];
      ...
      {
         Skills.basicFoeAttack(16,Element.BIO,20,Status.CONFUSE,1,isHard ? 50 : 25);
      }
      
      public function special4() : *
      {
         Skills.basicFoeAttack(30 / 2,Element.BIO,100);
      }
