package foes
{
   public class CreepIcicle extends Foe
   {
      public static var iconInfo:Array = [3,5];
      
      public var defended:Boolean = false;
      
      public function CreepIcicle(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
         graphicType = "Creep";
         ...
         SP = 3.7;
         gold = 22;
         dropList = [[Items.water,100],[Items.ice,25],[Items.glass,25]];
      ...
      {
         Skills.basicFoeAttack(35,Element.ICE,50,Status.CHILL,1,isHard ? 33 : 0);
      }
      
      public function attack3() : *
      {
         Skills.basicFoeAttack(38,Element.ICE,50,Status.CHILL,1,isHard ? 33 : 0);
      }
