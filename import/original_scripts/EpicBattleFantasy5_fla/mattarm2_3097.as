package EpicBattleFantasy5_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol5023")]
   public dynamic class mattarm2_3097 extends MovieClip
   {
      public var eq:int;
      
      public function mattarm2_3097()
      {
         super();
         addFrameScript(0,this.frame1,3,this.frame4,5,this.frame6,10,this.frame11,12,this.frame13);
      }
      ...
      internal function frame4() : *
      {
         try
         {
            if(parent.playerNo == 1 && (Players.P1equips[0] == 19 || Players.P1equips[0] == 21))
            {
               gotoAndStop(36);
            }
            if(parent.playerNo == 3 && Players.P3equips[0] == 9)
            {
               gotoAndStop(36);
            }
         }
