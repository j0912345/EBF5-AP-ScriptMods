package foes
{
   ...
   {
      public static var iconInfo:Array = [2,2];
      
      public function BushDark(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
         graphicType = "Bush";
         ...
         SP = 1;
         gold = 4.5;
         dropList = [[Items.claw,15],[Items.spike,2]];
