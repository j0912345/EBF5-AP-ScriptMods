package foes
{
   public class MonolithViking extends Foe
   {
      public static var iconInfo:Array = [4,11];
      
      public function MonolithViking(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
         ...
         SP = 19;
         gold = 150;
         dropList = [[Items.rune2,50],[Items.rune2,50],[Items.rune2,50],[Items.diamond,5],[Items.turnip,2]];
      ...
      public function takeTurn() : *
      {
         ...
         if(_loc1_ == 1 && Battle.randomFoe().buffs[Stats.ATTACK] >= 110)
         {
            _loc1_ = 3;
         }
      ...
      public function special6() : *
      {
         ...
         Skills.basicFoeMagic(100,Element.WIND,100,Status.CHILL,3,isHard ? 133 : 66);
      }
      ...
      public function special4() : *
      {
         ...
         {
            _loc1_.buff(Stats.ATTACK,30);
            if(isHard)
            {
               Skills.giveStatus(_loc1_,Status.GOOD_LUCK,3);
            }
         }
      }
      ...
      {
         if(isHard && Battle.randomFoe().buffs[Stats.EVADE] <= 105 && Math.random() < 0.25)
         {
            castSpell("Reflex");
         }
