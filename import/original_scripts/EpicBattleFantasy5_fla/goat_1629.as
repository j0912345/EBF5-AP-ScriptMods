package EpicBattleFantasy5_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol18958")]
   public dynamic class goat_1629 extends MovieClip
   {
      public var X:int;
      
      public var Y:int;
      
      public function goat_1629()
      {
         super();
      ...
      {
         (parent as Maps).addTile(35,x,y + 20);
         parent.addObject({
            "mc":this.name,
            "type":Maps.ANIMAL
         });
