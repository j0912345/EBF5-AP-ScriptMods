package foes
{
   public class BitWind extends Foe
   {
      public static var iconInfo:Array = [4,6];
      
      public function BitWind(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
         graphicType = "RockBit";
         ...
         SP = 1.2;
         gold = 5;
         dropList = [[Items.satin,10],[Items.gems,5]];
