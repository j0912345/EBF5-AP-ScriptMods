package foes
{
   public class SlimeIcecream extends Foe
   {
      public static var iconInfo:Array = [2,7];
      
      public function SlimeIcecream(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
         graphicType = "Slime";
      ...
      {
         Skills.basicFoeAttack(13,Element.ICE,20,Status.HUNGRY,1,isHard ? 10 : 0);
      }
      ...
      {
         Skills.basicFoeAttack(16,Element.ICE,20,Status.CONFUSE,1,isHard ? 30 : 10);
      }
