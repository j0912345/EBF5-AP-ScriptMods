package foes
{
   public class SlimeChocolate extends Foe
   {
      public static var iconInfo:Array = [2,10];
      
      public function SlimeChocolate(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
         graphicType = "Slime";
         ...
         SP = 1;
         gold = 5;
         dropList = [[Items.turd,30],[Items.coffee,5]];
      ...
      {
         Skills.basicFoeAttack(13,Element.EARTH,20,Status.HUNGRY,1,isHard ? 10 : 0);
      }
      ...
      {
         Skills.basicFoeAttack(16,Element.EARTH,20,Status.CONFUSE,1,isHard ? 30 : 10);
      }
