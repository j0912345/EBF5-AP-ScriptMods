package foes
{
   public class CreepThorny extends Foe
   {
      public static var iconInfo:Array = [3,4];
      
      public var defended:Boolean = false;
      
      public function CreepThorny(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
         graphicType = "Creep";
         ...
         SP = 3.7;
         gold = 22;
         dropList = [[Items.seashell,15],[Items.claw,30],[Items.spike,10]];
      ...
      {
         Skills.basicFoeAttack(30,Element.EARTH,25,Status.STUN,1,isHard ? 50 : 20);
      }
      
      public function attack2() : *
      {
         Skills.basicFoeAttack(33,Element.NONE,0);
      }
