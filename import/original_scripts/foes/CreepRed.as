package foes
{
   public class CreepRed extends Foe
   {
      public static var iconInfo:Array = [3,2];
      
      public var defended:Boolean = false;
      
      public function CreepRed(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
         graphicType = "Creep";
         ...
         SP = 3.7;
         gold = 22;
         dropList = [[Items.seashell,25],[Items.claw,15],[Items.feather,100]];
      ...
      {
         Skills.basicFoeAttack(45,Element.WIND,50,Status.STAGGER,1,isHard ? 25 : 10);
      }
      
      public function attack5() : *
      {
         Skills.basicFoeAttack(50 / 3,Element.NONE,0,Status.WEAKEN,2,isHard ? 50 : 25,200);
      ...
      {
         buff(Stats.MAGIC_DEFENCE,isHard ? 50 : 40);
         if(isHard)
         {
