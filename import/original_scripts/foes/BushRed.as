package foes
{
   public class BushRed extends Foe
   {
      public static var iconInfo:Array = [2,3];
      
      public function BushRed(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
         graphicType = "Bush";
         ...
         SP = 1;
         gold = 4.5;
         dropList = [[Items.root,20],[Items.wood,10],[Items.herb,10]];
