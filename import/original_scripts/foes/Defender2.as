package foes
{
   public class Defender2 extends Foe
   {
      public static var iconInfo:Array = [8,2];
      
      public var counterSpell:Boolean = false;
      
      public function Defender2(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
         ...
         SP = 23;
         gold = 220;
         dropList = [[Items.spring,100],[Items.cpu,50],[Items.kevlar,50],[Items.gamechild,10],[Items.riceball,2]];
      ...
      {
         Skills.basicFoeAttack(160,Element.WATER,100,Status.WET,5,100);
      ...
      public function magic1() : *
      {
         ...
         if(this.counterSpell)
         {
            ...
            if(Battle.randomPlayer().buffs[Stats.EVADE] > 90)
            {
               castSpell("Bind");
            }
            else if(Battle.randomPlayer().buffs[Stats.ACCURACY] > 90)
            {
               castSpell("Flare");
            }
            else
