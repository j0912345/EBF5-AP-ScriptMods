package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol12731")]
   public dynamic class Crosshair4 extends MovieClip
   {
      public var target:Target;
      
      public var alternative:Boolean;
      
      public function Crosshair4()
      {
         super();
      ...
      {
         Battle.menu.selectTarget(this.target,this.alternative);
         gotoAndStop(4);
      }
