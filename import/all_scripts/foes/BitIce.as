package foes
{
   public class BitIce extends Foe
   {
      public static var iconInfo:Array = [4,9];
      
      public function BitIce(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
         graphicType = "RockBit";
         ...
         SP = 1.2;
         gold = 5;
         dropList = [[Items.water,35],[Items.gems,5]];
      ...
      public function takeTurn() : *
      {
         ...
         if(_loc1_ == 0 && (Battle.randomFoe().buffs[Stats.MAGIC_DEFENCE] >= 115 || Battle.foeCount() == 1))
         {
            _loc1_ = 1;
         }
         if(isHard && _loc1_ == 1 && Math.random() > 0.2 + FoeAI.getPlayersWeakTo(Element.ICE,false,true).length / 3)
         {
            _loc1_ = -1;
         }
