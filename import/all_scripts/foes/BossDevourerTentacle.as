package foes
{
   public class BossDevourerTentacle extends Foe
   {
      public var headOff:Boolean = false;
      
      public function BossDevourerTentacle(param1:int, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         super();
         setStrings();
      ...
      public function magic1() : *
      {
         ...
         if(_loc1_ == 0)
         {
            castMultiSpell(Spells.devIce);
         }
         if(_loc1_ == 1)
         {
            castMultiSpell(Spells.devWind);
         }
      }
      
      public function attack1() : *
      {
         Skills.basicFoeAttack(70,Element.NONE,100,Status.SYPHON,2,isHard ? 100 : 50);
      }
      ...
      {
         if(dead || status[Status.SYPHON] || Boolean(status[Status.BERSERK]))
         {
            return;
         }
